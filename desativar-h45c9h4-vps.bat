@echo off
echo === DESATIVANDO VINCULAÇÃO DO H45C9H4 NA VPS ===
echo.

REM Fazer upload do script
echo [1/3] Enviando script para VPS...
scp backend/desativar-h45c9h4-vinculacao.js root@187.127.8.112:/var/www/apps/tech-refresh-backend/

REM Executar o script
echo.
echo [2/3] Executando script na VPS...
ssh root@187.127.8.112 "cd /var/www/apps/tech-refresh-backend && node desativar-h45c9h4-vinculacao.js"
