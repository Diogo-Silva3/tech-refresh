@echo off
echo === MUDANDO STATUS ENTREGA DO H45C9H4 NA VPS ===
echo.

REM Fazer upload do script
echo [1/3] Enviando script para VPS...
scp backend/mudar-h45c9h4-status-entrega.js root@187.127.8.112:/var/www/apps/tech-refresh-backend/

REM Executar o script
echo.
echo [2/3] Executando script na VPS...
ssh root@187.127.8.112 "cd /var/www/apps/tech-refresh-backend && node mudar-h45c9h4-status-entrega.js"
